...
RUN useradd -u 1000120000 -r -g 0 -s /sbin/nologin \
...
#        && chown -R 1000120000:0 /data/db \
# && mkdir -p /worker-dir && chown -R 1000120000:0 /worker-dir \
...
RUN  mkdir -p /data/db && chown -R 1000120000:0 /data/db 
...
# RUN chown -R 1000120000:0 /worker-dir
